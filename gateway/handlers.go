...
import (
	...
	"gomod.pri/helloGrpc/pkg/ui/data/swagger"
...
// openAPIServer returns OpenAPI specification files located under "/openapiv2/", like "openapiv2/all_in_one.swagger.json"
